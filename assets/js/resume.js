$(function(){
	...
	*/
	...
	function step4(){
		...
		$resume.addClass("myhover");
		$tpp.hide(300,function(){
			$(this).html("唉，惨不忍睹！我们先调整下头像和信息列表吧。").show(300);
		});
		step++;
	}
